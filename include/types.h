...
typedef enum OperatorFlag { SUM, SUBTRACTION, MULTIPLICATION, DIVISION, POW, EXP, TANH, DOT, SQRT, LOG, MAX, MIN, ABS, CONJUGATE } OperatorFlag;
...
const unsigned char operators_flags[] = { SUM, SUBTRACTION, MULTIPLICATION, DIVISION, POW, EXP, TANH, DOT, SQRT, LOG, MAX, MIN, ABS, CONJUGATE };
