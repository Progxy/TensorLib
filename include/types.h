...
typedef enum OperatorFlag { SUM, SUBTRACTION, MULTIPLICATION, DIVISION, POW, EXP, TANH, DOT, SQRT, LOG, MAX, MIN, ABS, CONJUGATE, NORM } OperatorFlag;
...
const unsigned char operators_flags[] = { SUM, SUBTRACTION, MULTIPLICATION, DIVISION, POW, EXP, TANH, DOT, SQRT, LOG, MAX, MIN, ABS, CONJUGATE, NORM };
